                ...
                <ul style="margin-right:0;" class="nav navbar-nav navbar-right">
                    <li>
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <img alt="" class="admin-pic img-circle" src="http://api.randomuser.me/portraits/thumb/men/10.jpg">您好, ${student.studentName}同学<b class="caret"></b>
                        </a>
                    ...
                    <ul class="topnav menu-left-nest">
                        ...
                        <li>
                            <a class="tooltip-tip ajax-load" href="mail.html" title="Mail">
                                <i class="icon-mail"></i>
                                <span>我的学校</span>
                                <div class="noft-blue">${student.studentCampus}</div>
                            </a>
                        </li>
                        ...
                        <li>
                            <a class="tooltip-tip ajax-load" href="icon.html" title="Icons">
                                ...
                                <span>我的企业</span>
                                <div class="noft-blue" style="display: inline-block; float: none;">${student.studentCompany}</div>
                            </a>
                        </li>
